...
class RoutingLabTopo(Topo):
    ...
    client1 -- r1 -- r2 -- server
                    /
                   r3

    client2 is connected to r1 on a separate interface, as in the
    original ÜB8 environment.  The two paths to the server have
    different delays so that routing choices can be investigated.
    """
